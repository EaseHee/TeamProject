...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="/TeamProject/views/assets/css/bootstrap.css">
<link rel="stylesheet"
	href="/TeamProject/views/assets/vendors/bootstrap-icons/bootstrap-icons.css">
<link rel="stylesheet" href="/TeamProject/views/assets/css/app.css">
<link rel="stylesheet"
	href="/TeamProject/views/assets/css/pages/auth.css">
<script
					...
					<form action="/TeamProject/signup" method="post" id="signupForm">
						...
						<div class="form-group position-relative has-icon-left md-4">
							<input type="text" name="name"
								class="form-control form-control-xl" placeholder="이름" id="name"
								required>
						...
						<div class="form-group position-relative has-icon-left mb-4">
							<input type="date" onclick="this.showPicker()" name="birth"
								class="form-control form-control-xl" placeholder="생년월일 6자리"
								id="birth" required>
							<div class="form-control-icon">
						...
						<div class="form-group position-relative has-icon-left mb-4">
							<input type="text" name="ph" class="form-control form-control-xl"
								placeholder="휴대전화" id="phone" required>
							<div class="form-control-icon">
						...
						<div class="d-flex align-items-center mb-4">
							<div class="flex-grow-1 me-2">
								<div class="form-group position-relative has-icon-left"
									...
									<input type="text" name="postcode"
										class="form-control form-control-xl" placeholder="우편번호"
										id="sample4_postcode" readonly required>
									<div class="form-control-icon">
										<i class="bi bi-envelope"></i>
									</div>
								</div>
							...
							<div>
								<input type="button"
									class="btn btn-outline-success form-control form-control-xl"
									onclick="sample4_execDaumPostcode()" value="우편번호 찾기">
							</div>
						</div>
						<div class="form-group position-relative has-icon-left mb-4">
							<input type="text" name="roadAddress"
								class="form-control form-control-xl" placeholder="도로명 주소"
								id="sample4_roadAddress" readonly required>
							<div class="form-control-icon">
								<i class="bi bi-envelope"></i>
							</div>
						</div>
						<div class="form-group position-relative has-icon-left mb-4">
							<input type="text" name="detailAddress"
								class="form-control form-control-xl" placeholder="상세 주소"
								id="sample4_detailAddress" required>
							<div class="form-control-icon">
								<i class="bi bi-envelope"></i>
							</div>
						</div>
						<div class="form-group position-relative has-icon-left mb-4">
							<input type="text" name="id" class="form-control form-control-xl"
								placeholder="아이디" id="userId" required>
							<div class="form-control-icon">
						...
						<div class="form-group position-relative has-icon-left mb-4">
							<input type="password" name="pwcheck"
								class="form-control form-control-xl" placeholder="비밀번호 확인"
						...
						<div class="form-check form-check-lg d-flex align-items-end">
							<input class="form-check-input me-2" type="checkbox" name="terms"
								onclick="toggleCheckboxes(this)" value="" id="all_terms">
							<label class="form-check-label text-gray-600" for="all_terms">
								모든 약관에 동의합니다. </label>
						</div>
						<div class="form-check form-check-lg d-flex align-items-end">
							<input class="form-check-input me-2" type="checkbox" name="terms"
								value="" id="terms1" required> <label
								class="form-check-label text-gray-600" for="terms1"> 이용
								약관에 동의합니다.[필수] </label>
						</div>
						<div class="form-check form-check-lg d-flex align-items-end">
							<input class="form-check-input me-2" type="checkbox" name="terms"
								value="" id="terms2" required> <label
								class="form-check-label text-gray-600" for="terms2"> 개인
								정보 수집 및 이용에 동의합니다.[필수] </label>
						</div>
						<div class="form-check form-check-lg d-flex align-items-end">
							<input class="form-check-input me-2" type="checkbox" name="terms"
								value="" id="terms3"> <label
								class="form-check-label text-gray-600" for="terms3"> 마케팅
								활용 및 광고성 정보 수신에 동의합니다.[선택] </label>
						</div>

						<button class="btn btn-primary btn-block btn-lg shadow-lg mt-5"
							onclick="validateForm()">가입하기</button>
						<div id="error-message" style="color: red;"></div>
					</form>
					<div class="text-center mt-5 text-lg fs-4">
						<p class='text-gray-600'>
							이미 계정이 있으신가요?<br> <a href="login.jsp" class="font-bold">로그인</a>
						</p>
					</div>
				</div>
			</div>
