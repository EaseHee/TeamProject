                ...
                <div id="auth-left">
                    ...
                    <form action="/TeamProject/signup" method="post" id="signupForm">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="birth" class="form-control form-control-xl" placeholder="생년월일 6자리" id="birth" required>
                            <div class="form-control-icon">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="postcode" class="form-control form-control-xl" placeholder="우편번호" id="sample4_postcode" required>
                            <div class="form-control-icon">
                                <i class="bi bi-envelope"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="roadAddress" class="form-control form-control-xl" placeholder="도로명 주소" id="sample4_roadAddress" required>
                            <div class="form-control-icon">
                                <i class="bi bi-envelope"></i>
                            </div>
                        </div>
